                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24">
                    ...
                    <div className="order-2 md:order-1 text-right space-y-8">
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start gap-4 flex-row-reverse"> {/* Reversed on mobile for RTL if needed, but flex-row in RTL is correct order: Icon | Text */}
...
<a href={Contact.whatsapp} target='_blank'><Button variant="primary" className="w-full sm:w-auto mt-4">
